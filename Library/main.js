...
// Create a div element to contain the read/unread checkbox
function createReadElement(bookItem, book) {
  let read = document.createElement("div");
  read.setAttribute("class", "book-read");

  // Create a title for the checkbox
  ...
  // If the book is marked as read, set the checkbox as checked
  if (book.read) {
    input.checked = true;
    bookItem.setAttribute("class", "card book read-checked");
  }

  // Append the checkbox to the "read" div
  read.appendChild(input);
  
  // Return the "read" div containing the checkbox
  return read;
}
...
function createEditIcon(book) {
  ...
  editIcon.src = "../icons/book-edit.svg";
